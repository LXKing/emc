...
import com.huak.auth.service.UserService;
import com.huak.base.service.ReversibleEncryption;
...
public class UserController {
    ...
    @Resource
    private CommonExcelExport commonExcelExport;
    ...
    public String list(@RequestParam Map<String, String> paramsMap, Page page) {
        ...
        try {
            jo.put(Constants.LIST, userService.findAuthByPage(paramsMap, page));
        } catch (Exception e) {
