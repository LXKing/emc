            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="addForm" role="form">
                        <input name="admLevel" value="1" class="form-control" type="hidden">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="admCode" id="admCode" class="form-control" type="text" maxlength="16" placeholder="请输入区划代码">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>区划名称：</label>
                            <div class="col-sm-4">
                                <input name="admName"  class="form-control" type="text" maxlength="11" placeholder="请输入区划名称">
                            </div>
                        </div>

                        <div class="form-group" style="display: none" id = "admTypeDiv" >
