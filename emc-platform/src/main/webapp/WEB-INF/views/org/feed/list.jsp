                    ...
                    <form id="roles-form" role="form" class="form-horizontal m-t">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-xs-3 col-md-3 col-lg-3">热源性质</label>
                                    <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                        <input type="text" class="form-control" name="feedType" placeholder="请输入热源性质">
                                    </div>
                                </div>
                            </div>
                            <div class="row1">
                                <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 col-xs-3 col-md-3 col-lg-3">供热类型</label>
                                        <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                                            <input type="text" class="form-control" name="heatType" placeholder="请输入热源性质">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row2">
                                <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 col-xs-3 col-md-3 col-lg-3">装机容量</label>
                                        <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4">
                                <div class="form-group">
                                    <label class="control-label col-sm-3 col-xs-3 col-md-3 col-lg-3">供热能力</label>
                                    <div class="col-sm-6 col-xs-6 col-md-6 col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8  btn-group">
                                ...
                                <button type="button" class="btn btn-sm btn-info top-layer-min" layer-form-id="feedAddForm" layer-title="添加热源" layer-url="${platform}/feed/add">
