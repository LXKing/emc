...
<head>
    ...
    <title>一次网段管理</title>
    <script src="${ctx}/script/org/huak.org.oncenetlinepart.list.js"></script>
</head>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form role="form" id="oncenetlinepart-form" >
                        ...
                        <tr class="row col-md-15">
                            ...
                            <div class="form-group col-md-2">
                                <input name="orgName" id="orgName" placeholder="一次网段名称"  class="form-control">
                            </div>
                        ...
                        <div class="row btn-margin-bottom0">
                            <div class="col-lg-8  btn-group">
                                <c:if test="${sessionScope._auth['bfanAdd']}">
                                    <button type="button" class="btn btn-sm btn-info J_menuItem"  data-href="${ctx}/oncenetlinepart/add">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="oncenetlinepartListTable">
                        <thead>
                        <tr>
                            <th width="7%">
                        ...
                        <tbody id="oncenetlinepart-tbody"></tbody>
                    </table>
...
<textarea id="tpl-list" style="display: none">
    ...
    <tr>
        ...
        <td>
            <a class="btn btn-info btn-xs btn-bitbucket J_menuItem"  data-href="${ctx}/oncenetlinepart/edit/{$T.item.orgId}" title="修改">
                <i class="fa fa-file-text-o"></i>
            </a>
            <a class="btn btn-danger btn-xs btn-bitbucket" title="删除" onclick="deloncenetlinepart('{$T.item.orgId}')">
