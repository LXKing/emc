...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#oncenetlinepart_edit_Form").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        url: ctx + '/oncenetlinepart/edit',
                        data: $('#oncenetlinepart_edit_Form').serialize(),
                        type: 'POST',
                        dataType: 'json',
                        success: function (result) {
                            if (result.flag) {
...
<form class="form-horizontal" id="oncenetlinepart_edit_Form" role="form">
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input name="orgCode"  class="form-control" value="${object.orgCode}" type="text" maxlength="20"
               placeholder="请输入一次网段编码">
    </div>
</div>
<div class="form-group">
