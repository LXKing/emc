                        ...
                        <div class="row">
                            <div class="col-sm-8 col-xs-8 col-md-8 col-lg-8  btn-group">
                            	<c:if test="${sessionScope._auth['banInsert'] }">
                                	<button id="addButton" type="button" class="btn btn-sm btn-info top-layer-min" layer-url="${platform}/ban/add" layer-title="新增小区" layer-form-id="banAddForm" ><i class="fa fa-plus"></i>添加</button>
                                </c:if>
                            </div>
