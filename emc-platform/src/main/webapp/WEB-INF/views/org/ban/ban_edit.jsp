...
//            },
        ...
        messages: {
            ...
            orgCode: {
                required: icon + "请填写楼栋编码"
            },
            orgName: {
                required: icon + "请填写楼栋名称"
            },
            addr: {
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="ban-edit-Form" role="form">
