        ...
        $(function () {
            ...
            $.validator.addMethod("roomCodeUnique", function(value, element) {
                ...
                if(oldCode == orgCode){
                    ...
                    $.ajax({
                        ...
                        data: {orgCode:orgCode,pOrgId:pOrgId},
                        dataType: 'json',
            ...
            $("#room_edit_form").validate({
                ...
                messages: {
                    ...
                    pOrgId: {
                        required: icon + "请填写上级单位"
                    },
                    orgCode: {
                        required: icon + "请填写房间号",    NOT_EMPTY: icon + "请选择上级单位！ "
                    },
                ...
                submitHandler: function () {
                    return parent.editRoomCollBack();
                }
            });
...
<div  class="wrapper wrapper-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="room_edit_form" role="form">
                <input type="hidden" name="orgId" value="${object.orgId}" />
                <input type="hidden" id="oldOrg" value="${object.orgCode}" />
                    ...
                    <div class="td">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group colorpicker-demo3">
                                ...
                                <input  type="text" placeholder="所属组织机构"  value="${org[object.pOrgId]}" readonly="readonly" disabled value="" class="form-control" />
