        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="bollmillAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="bollLoad" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入装球量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="inSize" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入进料粒度">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="outSize" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入出料粒度">
                                    <span class="input-group-addon">mm</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="yield" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入产量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="motorPower" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入电机功率">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="speed" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入转速">
...
$(function () {
    ...
    $("#bollmillAddFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/bollmill/add',
                data: $('#bollmillAddFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
