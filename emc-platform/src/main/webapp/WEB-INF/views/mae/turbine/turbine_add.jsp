        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="turbineAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="inletPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入进汽压力">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="extrationPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入抽汽压力">
                                    <span class="input-group-addon">MPa</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="exhaustPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入排汽压力">
                                    <span class="input-group-addon">MPa</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="powerRating" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定功率">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="extrationFlow" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入抽汽量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="speedRating" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定转速">
