        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="sweetenerEditFrom" role="form">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="maeId" value="${sweetener.mae_id}">
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>单位：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="orgId" value="${sweetener.org_id}" type="hidden"/>
                                    <input type="text" name="orgName" value="${sweetener.org_name}" id="common-part" placeholder="所属机构" disabled
                                           class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeName" class="form-control" type="text" maxlength="16" value="${sweetener.mae_name}"
                                       placeholder="请输入设备名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeNum" class="form-control" type="text" maxlength="32" value="${sweetener.mae_num}"
                                       placeholder="请输入产品编号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeTypeNum" class="form-control" type="text" maxlength="32" value="${sweetener.mae_type_num}"
                                       placeholder="请输入设备型号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMax" class="form-control" type="text" maxlength="8" value="${sweetener.eers_max}"
                                           placeholder="请输入最大能效">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMin" class="form-control" type="text" maxlength="8" value="${sweetener.eers_min}"
                                           placeholder="请输入最小能效">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firm" class="form-control" type="text" maxlength="32" value="${sweetener.firm}"
                                       placeholder="请输入生产厂商">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmDate" id="firmDate" class="form-control" type="text" value="${sweetener.firm_date}"
                                       placeholder="请选择出厂日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmTel" class="form-control" type="text" maxlength="32" value="${sweetener.firm_tel}"
                                       placeholder="请输入厂商电话">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedPower" class="form-control" type="text" maxlength="16" value="${sweetener.rated_power}"
                                           placeholder="请输入额定功率">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="fanFolw" class="form-control" type="text" maxlength="16" value="${sweetener.fan_folw}"
                                           placeholder="请输入处理风量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="sweetenerRate" class="form-control" type="text" maxlength="16" value="${sweetener.sweetener_rate}"
                                           placeholder="请输入脱硫率">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="dustRate" class="form-control" type="text" maxlength="16" value="${sweetener.dust_rate}"
                                           placeholder="请输入除尘率">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="inletDust" class="form-control" type="text" maxlength="16" value="${sweetener.inlet_dust}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="outletDust" class="form-control" type="text" maxlength="16" value="${sweetener.outlet_dust}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="waterConsumption" class="form-control" type="text" maxlength="16" value="${sweetener.water_consumption}"
                                           placeholder="请输入耗水量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maxTemp" class="form-control" type="text" maxlength="16" value="${sweetener.max_temp}"
                                           placeholder="请输入最高温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="seq" class="form-control" type="text" maxlength="4"  value="${sweetener.seq}" placeholder="请输入排序">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" rows="6" maxlength="125" name="memo"
                                          placeholder="请输入备注">${sweetener.memo}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
$(function () {
    ...
    $.validator.addMethod("nameUnique", function (value, element) {
        ...
        $.ajax({
            ...
            data: {maeName: value,maeId:${sweetener.mae_id}},
            dataType: 'json',
    ...
    $("#sweetenerEditFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/sweetener/edit',
                data: $('#sweetenerEditFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
