        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="heatpumpEditFrom" role="form">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="maeId" value="${heatpump.mae_id}">
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>单位：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="orgId" value="${heatpump.org_id}" type="hidden"/>
                                    <input type="text" name="orgName" value="${heatpump.org_name}" id="common-part" placeholder="所属机构" disabled
                                           class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeName" class="form-control" type="text" maxlength="16" value="${heatpump.mae_name}"
                                       placeholder="请输入设备名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeNum" class="form-control" type="text" maxlength="32" value="${heatpump.mae_num}"
                                       placeholder="请输入产品编号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeTypeNum" class="form-control" type="text" maxlength="32" value="${heatpump.mae_type_num}"
                                       placeholder="请输入设备型号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMax" class="form-control" type="text" maxlength="8" value="${heatpump.eers_max}"
                                           placeholder="请输入最大能效">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMin" class="form-control" type="text" maxlength="8" value="${heatpump.eers_min}"
                                           placeholder="请输入最小能效">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firm" class="form-control" type="text" maxlength="32" value="${heatpump.firm}"
                                       placeholder="请输入生产厂商">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmDate" id="firmDate" class="form-control" type="text" value="${heatpump.firm_date}"
                                       placeholder="请选择出厂日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmTel" class="form-control" type="text" maxlength="32" value="${heatpump.firm_tel}"
                                       placeholder="请输入厂商电话">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedVoltage" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定电压">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2  control-label">制冷量：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="coldCap" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入制冷量">
                                    <span class="input-group-addon">KW</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2  control-label">制热量：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="heatCap" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入制热量">
                                    <span class="input-group-addon">KW</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="seq" class="form-control" type="text" maxlength="4"  value="${heatpump.seq}" placeholder="请输入排序">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" rows="6" maxlength="125" name="memo"
                                          placeholder="请输入备注">${heatpump.memo}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
$(function () {
    ...
    $.validator.addMethod("nameUnique", function (value, element) {
        ...
        $.ajax({
            url: ctx + '/heatpump/check/name',
            type: 'POST',
            async: false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
            data: {maeName: value,maeId:${heatpump.mae_id}},
            dataType: 'json',
    ...
    $("#heatpumpEditFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/heatpump/edit',
                data: $('#heatpumpEditFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
