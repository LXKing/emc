        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="heatgcAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="smokeInletTemp" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入进烟温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="smokeOutletTemp" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入排烟温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="waterOutletTemp" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入出水温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="warmyhRate" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入保温率">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="smokeVolune" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入烟量">
