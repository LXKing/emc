        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="htboilerAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="heatPower" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="exitTemp" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="importTemp" class="form-control" type="text" maxlength="16"
...
$(function () {
    ...
    $("#htboilerAddFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/htboiler/add',
                data: $('#htboilerAddFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
