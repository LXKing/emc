        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="bfinEditFrom" role="form">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="maeId" value="${bfan.mae_id}">
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>单位：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="orgId" value="${bfan.org_id}" type="hidden"/>
                                    <input type="text" name="orgName" value="${bfan.org_name}" id="common-part" placeholder="所属机构" disabled
                                           class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeName" class="form-control" type="text" maxlength="16" value="${bfan.mae_name}"
                                       placeholder="请输入设备名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeNum" class="form-control" type="text" maxlength="32" value="${bfan.mae_num}"
                                       placeholder="请输入产品编号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeTypeNum" class="form-control" type="text" maxlength="32" value="${bfan.mae_type_num}"
                                       placeholder="请输入设备型号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMax" class="form-control" type="text" maxlength="8" value="${bfan.eers_max}"
                                           placeholder="请输入最大能效">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMin" class="form-control" type="text" maxlength="8" value="${bfan.eers_min}"
                                           placeholder="请输入最小能效">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firm" class="form-control" type="text" maxlength="32" value="${bfan.firm}"
                                       placeholder="请输入生产厂商">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmDate" id="firmDate" class="form-control" type="text" value="${bfan.firm_date}"
                                       placeholder="请选择出厂日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmTel" class="form-control" type="text" maxlength="32" value="${bfan.firm_tel}"
                                       placeholder="请输入厂商电话">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maxFolw" class="form-control" type="text" maxlength="16" value="${bfan.max_folw}"
                                           placeholder="请输入最大流量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="minFolw" class="form-control" type="text" maxlength="16" value="${bfan.min_folw}"
                                           placeholder="请输入最小流量">
                                    <span class="input-group-addon">m³/h</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maxPressure" class="form-control" type="text" maxlength="16" value="${bfan.max_pressure}"
                                           placeholder="请输入最大全压">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="minPressure" class="form-control" type="text" maxlength="16"  value="${bfan.min_pressure}"
                                           placeholder="请输入最小全压">
                                    <span class="input-group-addon">Pa</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mainSpeed" class="form-control" type="text" maxlength="16"  value="${bfan.main_speed}"
                                           placeholder="请输入主轴转速">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="motorPower" class="form-control" type="text" maxlength="16"  value="${bfan.motor_power}"
                                           placeholder="请输入电机功率">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mediumTemp" class="form-control" type="text" maxlength="16"  value="${bfan.medium_temp}"
                                           placeholder="请输入介质温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mediumDensity" class="form-control" type="text" maxlength="16" value="${bfan.medium_density}"
                                           placeholder="请输入介质密度">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="seq" class="form-control" type="text" maxlength="4"  value="${bfan.seq}" placeholder="请输入排序">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" rows="6" maxlength="125" name="memo"
                                          placeholder="请输入备注">${bfan.memo}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
$(function () {
    ...
    $.validator.addMethod("nameUnique", function (value, element) {
        ...
        $.ajax({
            url: ctx + '/bfan/check/name',
            type: 'POST',
            async: false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
            data: {maeName: value,maeId:'${bfan.mae_id}'},
            dataType: 'json',
