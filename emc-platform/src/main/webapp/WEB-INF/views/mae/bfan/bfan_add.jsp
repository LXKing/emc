        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="bfanAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maxFolw" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入最大流量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="minFolw" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入最小流量">
                                    <span class="input-group-addon">m³/h</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maxPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入最大全压">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="minPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入最小全压">
                                    <span class="input-group-addon">Pa</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mainSpeed" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入主轴转速">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mediumTemp" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入介质温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="mediumDensity" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入介质密度">
