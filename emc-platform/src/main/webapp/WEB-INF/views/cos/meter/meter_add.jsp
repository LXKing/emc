        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal mae-form-class" id="meterAddFrom" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="orgName" name="orgName" placeholder="所属机构" disabled class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input id="maeId" name="maeId" type="hidden"/>
                                    <input type="text" id="maeName" name="maeName" placeholder="所属设备" disabled class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="meterCode" id="meterCode" class="form-control" type="text" maxlength="16"
                                       placeholder="请输入器具编码">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="meterName" id="meterName" class="form-control" type="text" maxlength="16" placeholder="请输入器具名称">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="rate" id="rate" class="form-control" type="text" maxlength="8" placeholder="请输入倍率">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="location" id="location" class="form-control" maxlength="32" type="text" placeholder="请输入安装位置">
                            </div>
                        </div>
                        <div class="form-group">
    ...
    $(function () {
        ...
        $.validator.addMethod("nameUnique", function (value, element) {
            ...
            $.ajax({
                ...
                type: 'POST',
                async: false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
                data: {meterName: value,orgId:$("#orgId").val()},
                dataType: 'json',
                success: function (result) {
                    if (!result.flag) {
                        deferred.reject();
        ...
        $.validator.addMethod("meterTypeUnique", function (value, element) {
            var deferred = $.Deferred();//创建一个延迟对象
            $.ajax({
                url: ctx + '/meter/check/type',
                type: 'POST',
                async: false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
                data: {meterType: value,orgId:$("#orgId").val(),typeId:$("#typeId").val()},
                dataType: 'json',
                success: function (result) {
                    if (!result.flag) {
                        deferred.reject();
            ...
            //deferred.state()有3个状态:pending:还未结束,rejected:失败,resolved:成功
            return deferred.state() == "resolved" ? true : false;
        }, icon + "同一单位同一能源类型下，最多只有一个总表，总表和分支合并总表不能同时存在");
