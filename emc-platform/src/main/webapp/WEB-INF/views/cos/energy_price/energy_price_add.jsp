        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="energyPriceAddFrom" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="orgName" placeholder="所属机构" disabled class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="avgPrice" id="avgPrice" class="form-control" type="text"
    ...
    $(function () {
        ...
        $.validator.addMethod("checkSETime", function (value, element) {
            ...
            $.ajax({
                ...
                data: {typeId: $('#typeId').val(), orgId: $('#orgId').val(), sTime: $('#sTime').val(), eTime: $('#eTime').val()},
                dataType: 'json',
        ...
        $("#energyPriceAddFrom").validate({
            ...
            submitHandler: function () {
                ...
                $.ajax({
                    url: ctx + '/energy-price/add',
                    data: $('#energyPriceAddFrom').serialize(),
                    type: 'POST',
                    dataType: 'json',
                    success: function (result) {
                        if (result.flag) {
