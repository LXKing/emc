        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="chyEditFrom" role="form">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="maeId" value="${chy.mae_id}">
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>单位：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="orgId" value="${chy.org_id}" type="hidden"/>
                                    <input type="text" name="orgName" value="${chy.org_name}" id="common-part" placeholder="所属机构" disabled
                                           class="form-control"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeName" class="form-control" type="text" maxlength="16" value="${chy.mae_name}"
                                       placeholder="请输入设备名称">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeNum" class="form-control" type="text" maxlength="32" value="${chy.mae_num}"
                                       placeholder="请输入产品编号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="maeTypeNum" class="form-control" type="text" maxlength="32" value="${chy.mae_type_num}"
                                       placeholder="请输入设备型号">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMax" class="form-control" type="text" maxlength="8" value="${chy.eers_max}"
                                           placeholder="请输入最大能效">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="eersMin" class="form-control" type="text" maxlength="8" value="${chy.eers_min}"
                                           placeholder="请输入最小能效">
                                    <span class="input-group-addon">%</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firm" class="form-control" type="text" maxlength="32" value="${chy.firm}"
                                       placeholder="请输入生产厂商">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmDate" id="firmDate" class="form-control" type="text" value="${chy.firm_date}"
                                       placeholder="请选择出厂日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="firmTel" class="form-control" type="text" maxlength="32" value="${chy.firm_tel}"
                                       placeholder="请输入厂商电话">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedVoltage" class="form-control" type="text" maxlength="16" value="${chy.rated_voltage}"
                                           placeholder="请输入额定电压">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedPerssure" class="form-control" type="text" maxlength="16" value="${chy.rated_perssure}"
                                           placeholder="请输入额定压力">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedTemp" class="form-control" type="text" maxlength="16" value="${chy.rated_temp}"
                                           placeholder="请输入额定温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2  control-label">原水硬度：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="hardness" class="form-control" type="text" maxlength="16" value="${chy.hardness}"
                                           placeholder="请输入原水硬度">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2  control-label">出水硬度：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="whardness" class="form-control" type="text" maxlength="16" value="${chy.whardness}"
                                           placeholder="请输入出水硬度">
                                    <span class="input-group-addon">mmol/L</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-2  control-label">处理水量：</label>

                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="th" class="form-control" type="text" maxlength="16" value="${chy.th}"
                                           placeholder="请输入处理水量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="seq" class="form-control" type="text" maxlength="4"  value="${chy.seq}" placeholder="请输入排序">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <textarea class="form-control" rows="6" maxlength="125" name="memo"
                                          placeholder="请输入备注">${chy.memo}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
$(function () {
    ...
    $.validator.addMethod("nameUnique", function (value, element) {
        ...
        $.ajax({
            url: ctx + '/chy/check/name',
            type: 'POST',
            async: false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
            data: {maeName: value,maeId:${chy.mae_id}},
            dataType: 'json',
