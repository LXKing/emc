        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="chyAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="hardness" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入原水硬度">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="whardness" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入出水硬度">
                                    <span class="input-group-addon">mmol/L</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="th" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入处理水量">
