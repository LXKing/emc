        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="stboilerAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="waterCapacity" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入容水量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedPressure" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="steamTemp" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedCapacity" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="bodyScale" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入炉体重量">
                                    <span class="input-group-addon">kg</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                    <input name="licenseLevel" class="form-control" type="text" maxlength="4"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                    <input name="licenseNum" class="form-control" type="text" maxlength="16"
...
$(function () {
    ...
    $("#stboilerAddFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/stboiler/add',
                data: $('#stboilerAddFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
