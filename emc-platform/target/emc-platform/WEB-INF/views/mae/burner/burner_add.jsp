        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="burnerAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                    <input name="turndown" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入调节比">
                                </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="oilPressure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入油压">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="oilGun" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入油枪出力">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="sparyFlow" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="sparyPressure" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="gasFlow" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入燃气流量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="gasPressure" class="form-control" type="text" maxlength="16"
