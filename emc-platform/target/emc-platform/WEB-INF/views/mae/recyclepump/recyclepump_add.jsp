        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="recyclepumpAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedCurrent" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定电流">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedFlow" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定流量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedHead" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定扬程">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedSpeed" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定转速">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedPerssure" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定压力">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="ratedTemp" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入额定温度">
                                    <span class="input-group-addon">℃</span>
                                </div>
                            </div>
...
$(function () {
    ...
    $("#recyclepumpAddFrom").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url: ctx + '/recyclepump/add',
                data: $('#recyclepumpAddFrom').serialize(),
                type: 'POST',
                dataType: 'json',
                success: function (result) {
                    if (result.flag) {
