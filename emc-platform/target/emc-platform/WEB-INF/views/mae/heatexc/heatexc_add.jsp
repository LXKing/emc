        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="heatexcAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="heatTransfer" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入传热量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="transferArea" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入传热面积">
                                    <span class="input-group-addon">㎡</span>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="oswTemp" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="oswPressure" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="sswTemp" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="sswPressure" class="form-control" type="text" maxlength="16"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="maeScale" class="form-control" type="text" maxlength="16"
                                           placeholder="请输入设备重量">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input name="dn" class="form-control" type="text" maxlength="16"
