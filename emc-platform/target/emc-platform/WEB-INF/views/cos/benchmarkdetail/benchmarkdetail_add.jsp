...
<div id="company" class="wrapper wrapper-content">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="benchmarkdetailAddForm" role="form">
                <input name="strid" value="${object.did}" type="hidden"/>
                ...
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input id="eTime" name="eTime" value="${obj.birthday}"  class="form-control datepicker" type="text" placeholder="请选择结束日期">
                        </div>
                    </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    $(function () {
        ...
        $("#benchmarkdetailAddForm").validate({
