...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="${ctx}/static/Hplus/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" type="text/css" href="${ctx}/static/Hplus/css/demo/webuploader-demo.css">
    <link rel="stylesheet" type="text/css" href="${ctx}/static/Hplus/css/mystyle.css">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>H+ 后台主题UI框架 - 百度Web Uploader</title>
    <meta name="keywords" content="H+后台主题,后台bootstrap框架,会员中心主题,后台HTML,响应式后台">
    <meta name="description" content="H+是一个完全响应式，基于Bootstrap3最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术">
    <script src="${ctx}/static/Hplus/js/plugins/webuploader/webuploader.js"></script>
    <script src="${ctx}/script/sys/huak.sys.file.add.js"></script>
    <style>
        .filelist{
            width: 200px;
            height:10px;
