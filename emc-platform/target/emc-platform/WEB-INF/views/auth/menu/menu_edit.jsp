        ...
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="menuEditForm" role="form"  >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="menuName" class="form-control" value="${menu.menu_name}" type="text" maxlength="16" placeholder="请输入菜单名称">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="uName" class="form-control" disabled value="${menu.uname}" type="text" maxlength="32" placeholder="请输入唯一标识">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="url"  class="form-control" value="${menu.url}" type="text" maxlength="100" placeholder="请输入菜单链接，#表示无链接">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="imgName"  class="form-control" value="${menu.img_name}" type="text" maxlength="64" placeholder="请输入图标样式">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="isOwer" class="chosen-select form-control" >
                            ...
                            <option value="0" ${menu.isower eq 0?'selected':''}>公共</option>
                            <option value="1" ${menu.isower eq 1?'selected':''}>前台</option>
                            <option value="2" ${menu.isower eq 2?'selected':''}>后台</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="seq" value="${menu.seq}" class="form-control" type="text" maxlength="3" placeholder="请输入排序值">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" rows="6" maxlength="125" name="memo" placeholder="请输入备注">${menu.memo}</textarea>
                    </div>
                </div>
            </form>
        </div>
