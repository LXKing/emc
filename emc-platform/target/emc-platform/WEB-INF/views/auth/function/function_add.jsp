...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
            ...
            <form class="form-horizontal" id="functionAddForm" role="form"  >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="functionName" class="form-control" type="text" value="查询" maxlength="16" placeholder="请输入功能名称">
                    </div>
                </div>
                <div class="form-group">
