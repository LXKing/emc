        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="userAddFrom" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="phone" id="phone" class="form-control" type="text" maxlength="11" placeholder="请输入手机号码">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="jobNum" id="jobNum" class="form-control" type="text" placeholder="请输入工号，支持_-@">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="radio" name="selectLogin" value="1" checked>手机号
                                <input type="radio" name="selectLogin" value="2">工号
                                <input type="radio" name="selectLogin" value="3">自定义
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="login" id="login" class="form-control" type="text" maxlength="64" placeholder="请输入登录账号，支持_-@.">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="password" id="password" class="form-control" type="password" maxlength="32" placeholder="请设置密码">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="password1" class="form-control" type="password"  maxlength="32" placeholder="请再次输入密码">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="birthday" name="birthday" class="form-control" type="text" placeholder="请选择出生日期">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="age" id="age" class="form-control" type="text" maxlength="3" placeholder="请输入用户年龄">
                            </div>
                        </div>
