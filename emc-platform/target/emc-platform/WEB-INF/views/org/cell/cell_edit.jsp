                                ...
                                <div class="col-sm-4">
                                    <select id="cellTypeId" name="cellTypeId" class="chosen-select form-control" onchange="addMessage()" >
                                        ...
                                        <c:forEach items="${dicList['celltype']}" var="type">
                                            <option <c:if test="${object.cellTypeId eq type.dicName}">selected="selected" </c:if> value="${type.dicName}">${type.dicDes}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
