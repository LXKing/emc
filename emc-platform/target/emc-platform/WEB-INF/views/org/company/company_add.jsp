...
//                    dwellArea: { required: icon + "请输入正确的数字", number: icon + "请输入正确的数字"},
                ...
                submitHandler: function () {
                    return parent.adCompanydCollBack();
                }
            });
...
<div id="company" class="wrapper wrapper-content">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="org-add-Form" role="form">
                ...
                <div class="form-group">
                    <label class="col-sm-2  control-label"><span class="red">*</span>公司编码：</label>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
             <label class="col-sm-2  control-label"><span class="red">*</span>市：</label>
            <div class="col-sm-6">
        ...
        <div class="form-group">
            <label class="col-sm-2  control-label"><span class="red">*</span>县</label>
            <div class="col-sm-6">
        ...
        <div class="form-group">
            <label class="col-sm-2  control-label">镇(乡)</label>
            <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input name="addr" value="${object.addr}" class="form-control" type="text"
                       aria-required="true"
                       aria-invalid="false">
            </div>
        </div>
        ...
        <%--<div class="form-group">--%>
            ...
            <%--<div class="col-sm-6">--%>
                <%--<input name="publicArea" value="${object.publicArea}" class="form-control" type="text"--%>
                       <%--aria-required="true"--%>
                       <%--aria-invalid="false">--%>
            <%--</div>--%>
        <%--</div>--%>
        <%--<div class="form-group">--%>
            ...
            <%--<div class="col-sm-6">--%>
                <%--<input name="dwellArea" value="${object.dwellArea}" class="form-control" type="text"--%>
                       <%--aria-required="true"--%>
                       <%--aria-invalid="false">--%>
            <%--</div>--%>
        <%--</div>--%>
        <div class="form-group">
            <label class="col-sm-2 control-label"><span class="red">*</span>集团性质：</label>
            <div class="col-sm-4">
                <select data-placeholder="请选择集团性质..." name="groupTypeId" class="chosen-select form-control"
                        tabindex="2">
                    <option value="">请选择集团性质</option>
                    <option
                            <c:if test="${object.groupTypeId eq '1'}">selected="selected" </c:if> value="1"
                            hassubinfo="true">集团
                    </option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input name="seq" class="form-control" type="text" aria-required="true"
                       value="${object.seq}"
                       aria-invalid="false">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input name="lng" value="${object.lng}" class="form-control" type="text"
                       aria-required="true"
                       aria-invalid="false">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input name="lat" value="${object.lat}" class="form-control" type="text"
                       aria-required="true"
                       aria-invalid="false">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input name="memo" class="form-control" type="text" aria-required="true"
                       value="${object.memo}"
                       aria-invalid="false">
            </div>
        </div>
