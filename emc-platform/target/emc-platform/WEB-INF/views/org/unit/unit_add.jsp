...
$(function () {
    ...
    $.validator.addMethod("unitNameUnique", function(value, element) {
        ...
        if(pOrgId == ""||pOrgId == null||pOrgId =="undefinded"){
            ...
            $.ajax({
                url:ctx+'/room/check/org',
                type:'POST',
                async:false,//要指定不能异步,必须等待后台服务校验完成再执行后续代码
                data: {orgName:orgName,pOrgId:pOrgId},
                dataType: 'json',
                success:function(result) {
                    if (!result.flag) {
                        deferred.reject();
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="unit-add-Form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group colorpicker-demo3">
                                    ...
                                    <input  type="text" placeholder="上级单位" readonly="readonly" disabled value="${ban[object.pOrgId]}" class="form-control" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="orgName" class="form-control" value="${object.orgName}" type="text" maxlength="64" placeholder="请输入单元名称">
                            </div>
                        </div>
                        <div class="form-group">
