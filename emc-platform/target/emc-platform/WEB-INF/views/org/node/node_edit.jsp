...
$(function () {
    ...
    $("#station-edit-Form").validate({
        ...
        submitHandler: function () {
            ...
            $.ajax({
                url:ctx + '/node/edit',
                data:$('#station-edit-Form').serialize(),
                type:'POST',
                dataType:'json',
                success:function(result) {
                    if(result.flag){
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="station-edit-Form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="shortName" class="form-control" value="${object.shortName}" type="text" maxlength="64" placeholder="请输入热力站简称">
                            </div>
                        </div>
