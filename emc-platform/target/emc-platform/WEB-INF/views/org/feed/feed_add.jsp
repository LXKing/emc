                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="feed_add_Form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="orgCode" value="${object.orgCode}" class="form-control" type="text" maxlength="20" placeholder="请输入热源代码">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>热源名称：</label>
                            <div class="col-sm-4">
                                <input name="orgName" class="form-control" type="text" maxlength="64" placeholder="请输入热源名称">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>热源简称：</label>
                            <div class="col-sm-4">
                                <input name="shortName" class="form-control" type="text" maxlength="64" placeholder="请输入区划代码">
                            </div>
                        </div>
