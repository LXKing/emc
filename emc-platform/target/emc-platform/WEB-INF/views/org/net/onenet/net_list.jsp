...
<head>
    ...
    <title>一次网管理</title>
    <script src="${ctx}/script/org/huak.org.onenet.list.js"></script>
</head>
<body class="gray-bg">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                        <form role="form" id="net-search-form" >
                            ...
                            <tr class="row col-md-15">
                                ...
                                <div class="form-group col-md-2">
                                    <div class="input-group">
                                        <input type="hidden" class="form-control" name="pOrgId"/>
                                        <input type="text" placeholder="所属机构" disabled  class="form-control" />
                            ...
                            <div class="row btn-margin-bottom0">
                                <div class="col-lg-8  btn-group">
                                    <c:if test="${sessionScope._auth['bfanAdd']}">
                                        <button type="button" class="btn btn-sm btn-inf" onclick="addOncenet()">
                                            <i class="fa fa-plus"></i>添加
                                        </button>
                                    </c:if>
                                    <c:if test="${sessionScope._auth['bfanUpdate']}">
                                        <button type="button" class="btn btn-sm btn-info" onclick="editOncenet()">
                    ...
                    <table class="table table-bordered table-striped table-hover" id="oncenentTable">
                        <thead>
                        <tr>
                            <th width="7%">
...
<div id="orgWindow" style="display: none"></div>
<div id="feedWindow" style="display: none"></div>
<textarea id="net-list" style="display: none">
    ...
    <tr>
        ...
        <td >{$T.item.memo}</td>
        <td>
            <a class="btn btn-white btn-xs btn-bitbucket" title="修改" onclick="editOncenet('{$T.item.orgId}')">
                <i class="fa fa-file-text-o"></i>
            </a>
            <a class="btn btn-danger btn-xs btn-bitbucket" title="删除" onclick="delOncenet('{$T.item.orgId}')">
