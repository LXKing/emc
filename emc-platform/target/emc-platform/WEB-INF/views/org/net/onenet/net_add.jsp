...
<script>
    ...
    $(function () {
        ...
        $.validator.addMethod("oncenetCodeUnique", function(value, element) {
        ...
        $.validator.addMethod("oncenetNameUnique", function(value, element) {
            var deferred = $.Deferred();//创建一个延迟对象
            $.ajax({
                url:ctx+'/common/check/org',
                type:'POST',
        ...
        $("#net_add_form").validate({
            ...
            rules: {
                feeId: {required: true },
                orgId: { required: true},
                orgCode: { required: true, oncenetCodeUnique: true,maxlength:20},
                orgName: { required: true,maxlength:64,oncenetNameUnique:true},
...
<div class="wrapper wrapper-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="net_add_form" role="form">
                    ...
                    <div class="td">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group colorpicker-demo3">
                                ...
                                <input   placeholder="所属机构" readonly="readonly" disabled value="" class="form-control" />
                ...
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input id="orgCode" name="orgCode"  class="form-control" value="" type="text">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input name="medium" class="form-control" type="text" aria-required="true" value=""
                                   aria-invalid="false">
                        </div>
                    </div>
                </div>
