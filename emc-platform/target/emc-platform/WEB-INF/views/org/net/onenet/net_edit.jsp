...
<div id="oncenet" class="wrapper wrapper-content">
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="net_edit_form" role="form">
                <input id="oldCode"  value="${object.orgCode}" class="form-control" type="hidden" />
                <input  name="orgId" value="${object.orgId}" class="form-control"type="hidden" />
                ...
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input id="orgCode" name="orgCode"  class="form-control" value="${object.orgCode}" type="text">
                        </div>
                    </div>
                </div>
                <div class="form-group">
