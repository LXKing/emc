...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            $("#secondnetlinepart_add_Form").validate({
                ...
                submitHandler: function () {
                    ...
                    $.ajax({
                        url:ctx + '/secondnetlinepart/add',
                        data:$('#secondnetlinepart_add_Form').serialize(),
                        type:'POST',
                        dataType:'json',
                        success:function(result) {
                            if(result.flag){
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" id="secondnetlinepart_add_Form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input name="orgCode" class="form-control" value="${object.orgCode}" type="text" maxlength="20" placeholder="请输入二次网段编码">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2  control-label"><span class="red">*</span>二次网段名称：</label>
                            <div class="col-sm-4">
                                <input name="orgName" class="form-control" value="${object.orgName}" type="text" maxlength="64" placeholder="请输入二次网段名称">
                            </div>
                        </div>
