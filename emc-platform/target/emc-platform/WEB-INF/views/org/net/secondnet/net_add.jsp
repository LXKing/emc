...
<div id="company" class="wrapper wrapper-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <form class="form-horizontal" id="secondnet_add_form" role="form">
                ...
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input id="orgCode" name="orgCode"  class="form-control" value="${object.orgCode}" maxlength="20" type="text">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="td">
                        ...
                        <div class="col-md-6">
                            <input name="orgName" id="orgName" value="${object.orgName}" class="form-control" type="text">
                        </div>
                    </div>
                </div>
