 ...
 */
public class ToolVO {
    private String toolOrgId;//组织机构主键
    private String toolFeedType;//集中供暖和区域供暖
    private String toolStartDate;//开始时间
    private String toolEndDate;//结束时间
    private String toolStartDateTq;//开始时间同期
    private String toolEndDateTq;//结束时间同期
