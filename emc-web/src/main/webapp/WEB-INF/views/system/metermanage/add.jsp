        ...
        <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
            <form class="form-horizontal" id="addMeterCollectAddForm" role="form">
                ...
                <div  class="form-group" id="formula" style="display: none;">
                    ...
                    <div class="col-sm-7">
                        <div class="input-group m-b">
                            <input type="text" name="formula" autocomplete="off" class="form-control inputs-lg" maxlength="16" placeholder="请输入公式">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input name="tag" id="tag" class="form-control inputs-lg" type="text" maxlength="16" placeholder="请输入点表">
                    </div>
                </div>
                <div class="form-group">
