...
<form id="formForExport">
    <div class="main-box" style="min-height: 1000px">
        ...
        <div class="col-xs-12 main-table no-padding" style="overflow:scroll;width:100%;height: 100%">
            <table class="table table-striped table-bordered table-hover pgtable" style="width:1800px" align="center">
                ...
                <tr>
                    <td colspan="10"  style="text-align: center">电厂东西线能耗情况统计表</td>
                    <td colspan="4"  style="text-align: center">查表时间</td>
                ...
                <tr>
                    ...
                    <td colspan="2">能耗量</td>
                    <td rowspan="2">各换热站耗能统计(GJ)</td>
                    <td rowspan="2">热漏失率</td>
                    <td rowspan="2" colspan="2">上次查表时间</td>
                    <td rowspan="2" colspan="2">2017/11/15 9:00:00</td>
                    <td>日期</td>
                    <td>最高温度</td>
                    <td>最低温度</td>
                    <td>平均温度</td>
                    <td colspan="2">天气情况</td>
                </tr>
                <tr>
                    <td>用热量（GJ）</td>
                    <td>少回水量(t)</td>
                ...
                <tr>
                    ...
                    <td >-157878</td>
                    <td >-45.24%</td>
                    <td colspan="2">本次查表时间</td>
                    <td colspan="2">2017/11/17 9:00:00</td>
                    <td >2017/11/16</td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td colspan="20" style="text-align: center">各换热站日报统计表(2017-11-15——2017-11-17)</td>
                </tr>
                <tr>
                    <td rowspan="2" colspan="2">换热站名称</td>
                    <td rowspan="2" >供热面积</td>
                    <td colspan="3">上次表底</td>
                    <td colspan="3">本次表底</td>
                    <td></td>
                    <td colspan="3">能耗量</td>
                    <td colspan="3">单位能耗（kg KWh GJ /平方米.天）</td>
                    <td colspan="4">单耗（元/平方米.天）</td>
                </tr>
                <tr>
                    <td>用热量（GJ）</td>
                    <td>水(t）</td>
