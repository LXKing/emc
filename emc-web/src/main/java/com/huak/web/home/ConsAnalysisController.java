...
public class ConsAnalysisController {
	...
	public String energyFlowTable(@RequestParam Map<String,String> params){
        ...
        try{
            ...
            //查询折线数据
            List<Map<String,Object>> retMap = consAnalysisService.energyFlowTable(params);
            jo.put("data", retMap);
        }catch(Exception e){
	...
	public String energyFlowPie(@RequestParam Map<String,String> params){
        ...
        try{
            ...
            //查询折线数据
            List<Map<String,Object>> retMap = consAnalysisService.energyFlowPie(params);
            jo.put("data", retMap);
        }catch(Exception e){
	...
	public String energyFlowLine(@RequestParam Map<String,String> params){
        ...
        try{
            ...
            //查询折线数据
            Map<String,Object> retMap = consAnalysisService.energyFlowLine(params);
            jo.put("data", retMap);
        }catch(Exception e){
	...
	public String energyFlowBar(@RequestParam Map<String,String> params){
        ...
        try{
            ...
            //查询折线数据
            Map<String,Object> retMap = consAnalysisService.energyFlowBar(params);
            jo.put("data", retMap);
        }catch(Exception e){
	...
	public void exportEnergyFlowDetail(HttpServletResponse response,@RequestParam Map<String,String> params){
        ...
        try {
	        ...
	        cellName.put("curGroup", "单耗总量本期");
	        cellName.put("lastGroup", "单耗总量同期");
	        cellName.put("groupS", "单耗总量同比");
	        cellName.put("curWater", "水单耗量本期");
	        cellName.put("lastWater", "水单耗量同期");
	        cellName.put("waterS", "水单耗量同比");
	        cellName.put("curElec", "电单耗量本期");
	        cellName.put("lastElec", "电单耗量同期");
	        cellName.put("elecS", "电单耗量同比");
	        cellName.put("curGas", "气单耗量本期");
	        cellName.put("lastGas", "气单耗量同期");
	        cellName.put("gasS", "气单耗量同比");
	        cellName.put("curHot", "热单耗量本期");
	        cellName.put("lastHot", "热单耗量同期");
	        cellName.put("hotS", "热单耗量同比");
	        cellName.put("curCoal", "煤单耗量本期");
	        cellName.put("lastCoal", "煤单耗量同期");
	        cellName.put("coalS", "煤单耗量同比");
	        List<Map<String, Object>> cellValues = consAnalysisService.exportEnergyFlowDetail(params);
            if(cellValues==null){
                ...
                response.setContentType(mimetype);
                response.setCharacterEncoding("UTF-8");
                String fileName = "能源流-单耗列表.xls";
                response.setHeader("Content-Disposition", "attachment; filename=" + URLEncoder.encode(fileName, "UTF-8"));
                wb.write(out);
                out.flush();
            }
        } catch (Exception e) {
            logger.error("导出能源流-单耗列表EXCEL异常" + e.getMessage());
        }
	}
}
